// ============================================================
// sensor.h — MPU6050 Sensor Reading, Calibration, Mount Rotation
// ============================================================
#ifndef SENSOR_H
#define SENSOR_H
...
// ================= RANGES =================
#define ACCEL_4G_LSB     8192.0   // LSB per g (4G range)
#define GYRO_500DPS_LSB  65.5      // LSB per deg/s (500dps range)
...
struct CalibrationData {
    ...
    int16_t  gyro_bias_z;
    int16_t  temp_coeff;
    uint8_t  mount_mode;         // 0=standard, 1=90°, 2=180°, 3=270°
    bool     is_calibrated;
...
extern QueueHandle_t recoveryQueue;
extern volatile bool g_sensorDegraded;
